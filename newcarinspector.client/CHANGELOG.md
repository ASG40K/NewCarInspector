...
- Create Angular project with ng: `ng new newcarinspector.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`newcarinspector.client.esproj`).
